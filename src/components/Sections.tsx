    ...
    <div className="bg-[#0b1538] text-white">
      ...
      <section className="bg-white py-16 md:py-24" style={{ color: 'var(--primary-navy)' }}>
        ...
        <div className="max-w-[1325px] mx-auto px-6 md:px-8 mt-10 md:mt-12 grid md:grid-cols-2 gap-6">
          {cards.map((card) => (
            <div
              key={card.title}
              className="rounded-2xl flex flex-col p-4 md:p-3"
            ...
            >
              ...
              <div className="pt-5 md:pt-6 space-y-3 text-left">
                <div className="flex items-center justify-between gap-4">
                  ...
                  <Link to="/">
                    <button 
                      className="cursor-pointer inline-flex shrink-0 items-center justify-center rounded-md text-black font-medium px-4 py-2 transition-colors whitespace-nowrap text-sm"
              ...
              {execSteps.map((item) => (
                <div key={item.step} className="space-y-4 relative z-10">
                  <div className="flex flex-col items-center gap-4">
                    <div 
                      className="w-12 h-12 rounded-full text-white font-semibold grid place-items-center shadow-[0_10px_25px_rgba(0,0,0,0.1)]"
      ...
      <section className="bg-white py-16 md:py-24" style={{ color: 'var(--primary-navy)' }}>
        <div className="max-w-6xl mx-auto px-6 md:px-8 space-y-4 text-center">
          ...
          <p className="text-sm md:text-base max-w-4xl mx-auto" style={{ color: 'var(--text-secondary)' }}>
