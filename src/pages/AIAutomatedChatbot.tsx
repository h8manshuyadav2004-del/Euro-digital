                ...
                <div className="grid md:grid-cols-2 gap-0">
                  ...
                  <div className="p-8 md:p-12 flex flex-col justify-center">
                    ...
                    <div className="mb-8">
                      ...
                      <span className="text-base text-slate-600 ml-3">($29 / Month GHL Subscription)</span>
                    </div>
              ...
              >
                <div className="grid md:grid-cols-2 gap-0">
                  <div className="p-8 md:p-12 flex flex-col justify-center">
                    ...
                    <div className="mb-8">
                      <span className="text-6xl md:text-7xl font-bold text-slate-700">$899</span>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center gap-3">
                        <span className="text-green-500 text-2xl font-bold">✓</span>
                        <span className="text-slate-700 text-lg">Advanced AI Responses</span>
                      </div>
                      <div className="flex items-center gap-3">
                        <span className="text-green-500 text-2xl font-bold">✓</span>
                        <span className="text-slate-700 text-lg">Multi-Agent Support</span>
                      </div>
                      <div className="flex items-center gap-3">
                        <span className="text-green-500 text-2xl font-bold">✓</span>
              ...
              >
                <div className="grid md:grid-cols-2 gap-0">
                  <div className="p-8 md:p-12 flex flex-col justify-center">
                    ...
                    <div className="mb-8">
                      <span className="text-6xl md:text-7xl font-bold text-slate-700">$1,299</span>
                      <span className="text-xl text-slate-600 ml-3">Per Month</span>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center gap-3">
                        <span className="text-green-500 text-2xl font-bold">✓</span>
                        <span className="text-slate-700 text-lg">Unlimited Messages</span>
                      </div>
                      <div className="flex items-center gap-3">
                        <span className="text-green-500 text-2xl font-bold">✓</span>
                      ...
                      <div className="flex items-center gap-3">
                        <span className="text-green-500 text-2xl font-bold">✓</span>
                        <span className="text-slate-700 text-lg">Custom AI Training</span>
                      </div>
                      <div className="flex items-center gap-3">
                        <span className="text-green-500 text-2xl font-bold">✓</span>
