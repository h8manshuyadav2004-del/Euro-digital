            ...
            <div className="grid md:grid-cols-2 gap-12 items-start">
              ...
              >
                ...
                <div className="relative z-10">
                  <h1 className="text-4xl md:text-5xl font-bold mb-3 text-center" style={{ color: 'var(--primary-navy)' }}>
                    Contact Us
                  </h1>
                  <p className="text-base mb-10 leading-relaxed text-center" style={{ color: 'var(--primary-navy)' }}>
                    See how Company helps you deploy voice AI agents at scale.<br />
                  ...
                  <div className="mb-8 backdrop-blur-sm rounded-2xl p-5 shadow-2xl">
                    <div className="flex items-start gap-3 mb-4">
                      ...
                      <div className="flex-1">
                        <h3 className="font-bold text-lg mb-2" style={{ color: 'var(--primary-navy)' }}>
                          Corporate Office (UAE)
                        </h3>
                        <p className="text-sm leading-relaxed" style={{ color: 'var(--primary-navy)' }}>
                    ...
                    <div className="flex items-center gap-3 pl-14">
                      ...
                      <div>
                        <p className="text-xs font-semibold mb-0.5" style={{ color: 'var(--primary-navy)' }}>Phone No.</p>
                        <p className="text-sm font-bold" style={{ color: 'var(--primary-navy)' }}>+971 561874676</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mb-8 bg-white/60 backdrop-blur-sm rounded-2xl p-5 shadow-sm">
                    ...
                    <div className="flex items-center gap-3 pl-14">
                      ...
                      <div>
                        <p className="text-xs font-semibold mb-0.5" style={{ color: 'var(--primary-navy)' }}>Phone No.</p>
                        <p className="text-sm font-bold" style={{ color: 'var(--primary-navy)' }}>+91 9820638638</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-5 shadow-sm">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-xs font-semibold mb-0.5" style={{ color: 'var(--primary-navy)' }}>Email</p>
                        <p className="text-sm font-bold" style={{ color: 'var(--primary-navy)' }}>support@eurodigital.site</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white">
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-medium mb-2" style={{ color: 'var(--primary-navy)' }}>
                        First Name
                      </label>
                      <input
                        type="text"
